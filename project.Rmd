...
Since these are functions of another variable, they should generally be omitted and furthermore they frequently `NA` (only have values at `new_window` rows, and notably these do not occur in the test data), so there is no value to include them as predictors.  
